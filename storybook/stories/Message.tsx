			...
			attachments={[
				{
					...
					description: 'This is a description',
					image_url:
						'/file-upload/sxLXBzjwuqxMnebyP/Clipboard%20-%2029%20de%20Agosto%20de%202018%20%C3%A0s%2018:10'
				}
			]}
		/>
...
###### H6" />
		...
		<Message msg="Inline `code` has `back-ticks around` it.
```
Code block
```" />
		...
		<Message msg="First Header | Second Header
------------ | -------------
